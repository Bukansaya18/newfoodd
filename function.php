...
$header[] = "X-UniqueId: ".time()."57".mt_rand(-7.8762457,110.4264663);
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.8762457,110.4264663".mt_rand(-7.8762457,110,4264663).",-7.8762457,110.4264663".mt_rand(-7.8762457,110.4264663);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
